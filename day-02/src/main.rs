...
fn main() -> Result<()> {
    ...
    // - aim, where up and down instructions change the tilt of the submarine, and forward instruction propels forward
    ...
    for line in lines {
        ...
        // NOTE: Submarine coordinates:
        // - origin is (0,0) at the surface
        // - y down is positive
        match instruction {
            Forward(offset) => {
    ...
    // Print the solutions: final x and y coordinates multiplied
